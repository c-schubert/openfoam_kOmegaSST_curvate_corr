...
tmp<volScalarField>
kOmegaSSTCC<MomentumTransportModel, BasicMomentumTransportModel>::kOmegaSSTCC::F1
(
...
template<class MomentumTransportModel, class BasicMomentumTransportModel>
tmp<volScalarField>
kOmegaSSTCC<MomentumTransportModel, BasicMomentumTransportModel>::kOmegaSSTCC::
F2() const
{
...
template<class MomentumTransportModel, class BasicMomentumTransportModel>
void kOmegaSSTCC<MomentumTransportModel, BasicMomentumTransportModel>::correctNut
(
...
template<class MomentumTransportModel, class BasicMomentumTransportModel>
void kOmegaSSTCC<MomentumTransportModel, BasicMomentumTransportModel>::
correctNut()
{
...
kOmegaSSTCC<MomentumTransportModel, BasicMomentumTransportModel>::Pk
(
...
template<class MomentumTransportModel, class BasicMomentumTransportModel>
tmp<volScalarField::Internal>
kOmegaSSTCC<MomentumTransportModel, BasicMomentumTransportModel>::epsilonByk
(
...
template<class MomentumTransportModel, class BasicMomentumTransportModel>
tmp<fvScalarMatrix>
kOmegaSSTCC<MomentumTransportModel, BasicMomentumTransportModel>::kSource() const
{
...
template<class MomentumTransportModel, class BasicMomentumTransportModel>
tmp<fvScalarMatrix>
kOmegaSSTCC<MomentumTransportModel, BasicMomentumTransportModel>::
omegaSource() const
{
    return tmp<fvScalarMatrix>
    (
...
template<class MomentumTransportModel, class BasicMomentumTransportModel>
tmp<fvScalarMatrix>
kOmegaSSTCC<MomentumTransportModel, BasicMomentumTransportModel>::Qsas
(
...
template<class MomentumTransportModel, class BasicMomentumTransportModel>
bool kOmegaSSTCC<MomentumTransportModel, BasicMomentumTransportModel>::read()
{
...
template<class MomentumTransportModel, class BasicMomentumTransportModel>
void kOmegaSSTCC<MomentumTransportModel, BasicMomentumTransportModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
...
// Compute rStar
    ...
    (
        max(2.0*tSkew() && tSkew(),
        dimensionedScalar(dimless/pow(dimTime,2), 0.0))
    );
    volScalarField w
    (
        atan(dimensionedScalar(pow(dimTime,2), 0.0)*asymInnerProduct)*2.0/(constant::mathematical::pi)*(asymInnerProduct-symInnerProduct)+symInnerProduct
    );
    ...
    volScalarField w2
    (
        atan(dimensionedScalar(pow(dimTime,2), 1.0e-2)*asymInnerProduct)*2.0/(constant::mathematical::pi)*(sqrt(asymInnerProduct)-D)+D //T
    );
